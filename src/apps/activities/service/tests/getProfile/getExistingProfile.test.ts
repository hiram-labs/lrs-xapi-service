...
import { JSON_CONTENT_TYPE, TEST_CONTENT, TEST_JSON_CONTENT, TEXT_CONTENT_TYPE } from '../../../utils/testValues';
import setup from '../utils/setup';

describe('getProfile with existing state', () => {
  setup();

  const assertGetProfile = async (result: GetProfileResult, content: string, contentType: string) => {

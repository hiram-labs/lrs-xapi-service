...
const translator: Translator = {
  conflictError: () => 'Get the profile to retrieve the Etag, then set the If-Match header to the Etag',
  expiredClientError: () => `Your organisation has expired`,
  ifMatchError: () => 'IfMatch does not match Etag because a modification has been made since it was retrieved',

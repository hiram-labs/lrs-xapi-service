...
describe('get statements by sorting', () => {
  ...
  it('should return statements in the correct order when ascending', async () => {
    ...
    const expectedStatementsOrder = [TEST_ID_1, TEST_ID_2, TEST_ID_3, TEST_ID_4, TEST_ID_5, TEST_ID_6];
  ...
  it('should return statements in the correct order when ascending', async () => {
    ...
    const actualStatementsOrder = statements.map((s) => s.id);
    const expectedStatementsOrder = [TEST_ID_6, TEST_ID_5, TEST_ID_4, TEST_ID_3, TEST_ID_2, TEST_ID_1];

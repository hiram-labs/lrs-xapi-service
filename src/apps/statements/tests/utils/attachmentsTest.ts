...
export type AttachmentAsserter = (expectedIds: string[], expectedAttachments: any[]) => Promise<void>;

export type StatementCreator = (attachments: any[], id?: string) => any;

export default (service: Service, assertAttachments: AttachmentAsserter, createStatement: StatementCreator) => {

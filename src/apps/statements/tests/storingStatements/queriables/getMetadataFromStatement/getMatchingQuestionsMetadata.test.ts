...
import { multipleMatchingQuestions, singleMatchingQuestion } from './fixtures/matching-interaction.fixture';
...
describe('Retrieve matching questions metadata from statement', () => {
  ...
  it('should return metadata from single matching question', () => {
    const actualSingleMatchingQuestionMetadata = getMatchingQuestionsMetadata(singleMatchingQuestion);
  ...
  it('should return metadata from multiple matching questions', () => {
    const actualMultipleMatchingQuestionsMetadata = getMatchingQuestionsMetadata(multipleMatchingQuestions);

...
import IfiCountWarning from '@hiram-labs/lrs-xapi-validation/dist/warnings/IfiCountWarning';
import NoIfiWarning from '@hiram-labs/lrs-xapi-validation/dist/warnings/NoIfiWarning';
